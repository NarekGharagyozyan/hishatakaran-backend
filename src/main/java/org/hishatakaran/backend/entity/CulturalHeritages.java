...
@Entity
@Table(name = "cultural_heritages")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class CulturalHeritages {
  ...
  public CulturalHeritages(String titleHy, String titleEn, String titleFr, String subtitleHy, String subtitleEn,
